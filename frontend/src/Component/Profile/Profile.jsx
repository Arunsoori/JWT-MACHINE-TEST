...
function Profile() {
        ...
        const verifyUser = async () => {
            if (!cookies.jwt) {
                ...
                if (!data.status) {
                    ...
                    let profilePic = userDetails.image ? `http://localhost:5000/${userDetails.image}` : "https://www.w3schools.com/howto/img_avatar2.png"
    ...
    function uploadImage() {
        ...
        axios.post("http://localhost:5000/uploadimage", formData, { withCredentials: true }).then((data) => {
